...
7. [Augur: The Pioneer](#augur-the-pioneer)
8. [Technical Architecture Comparison](#technical-architecture-comparison)
9. [Payment Flow Analysis](#payment-flow-analysis)
10. [Competitive Analysis](#competitive-analysis)
11. [Revenue Models & Profitability](#revenue-models--profitability)
...
Prediction markets are **financial markets created for the purpose of trading the outcome of future events**. Participants buy and sell shares that pay out based on whether specific outcomes occur, with market prices reflecting the collective probability assigned by traders.
...
User deposits $100 USDC
    ↓
Buys "YES" shares for event: "Bitcoin above $100k by Dec 31, 2025"
    ↓
Current price: $0.60 per share (implies 60% probability)
    ↓
Buys 166 shares ($100 / $0.60)
    ↓
Outcomes:
- If BTC > $100k: Receives $166 (each share pays $1)
- If BTC < $100k: Receives $0 (shares expire worthless)
```

### Types of Prediction Markets

**1. Binary Markets** (Yes/No outcomes)
- "Will Trump win 2024 election?" → YES or NO
- Each outcome token represents probability
- Payoff: $1 if correct, $0 if wrong

**2. Categorical Markets** (Multiple exclusive outcomes)
- "Who will win the Super Bowl?" → Team A, Team B, Team C, etc.
- Only one outcome can occur
- Winning outcome pays $1, others $0

**3. Scalar Markets** (Range of values)
- "What will ETH price be on Dec 31?" → Ranges ($1000-$1500, $1500-$2000, etc.)
- Allows betting on price ranges or continuous outcomes

### Why They Work: Aggregated Intelligence
...
- **PredictIt:** Within 2-3% of actual election outcomes on average
- **Sports Betting Markets:** Consistently more accurate than expert predictions
...
## Azuro Protocol: Betting Infrastructure
